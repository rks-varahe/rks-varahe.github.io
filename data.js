...
const TEAMS = [
    ...
    },
    {
      ...
      "teamCalc": {
        "formula": "<div style=\"display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:14px;margin:6px 0 4px\"><div style=\"background:#ecfdf5;border:1px solid #6ee7b7;border-radius:12px;padding:16px;position:relative\"><div style=\"position:absolute;top:12px;right:12px;background:#16a34a;color:#fff;font-size:10px;font-weight:700;padding:3px 9px;border-radius:20px;letter-spacing:.6px\">RECOMMENDED</div><div style=\"font-size:16px;font-weight:700;color:#0f172a\">Hiring Team from Scratch</div><div style=\"display:inline-block;background:#fff;border:1px solid #86efac;color:#15803d;font-size:11.5px;font-weight:600;padding:3px 9px;border-radius:20px;margin-top:8px\">Ideal Period: More than 2 Months time for election date</div><div style=\"margin:10px 0 0;font-size:13px;color:#334155;line-height:1.55\">This is the <b>most suitable and recommended model</b>, as it ensures better ideological alignment and thorough skill evaluation during hiring.<br><br>Under this model, SMAs are directly hired and integrated into the team structure.</div></div><div style=\"background:#fff7ed;border:1px solid #fb923c;border-radius:12px;padding:16px\"><div style=\"font-size:16px;font-weight:700;color:#0f172a\">Vendorising</div><div style=\"display:inline-block;background:#fff;border:1px solid #fdba74;color:#c2410c;font-size:11.5px;font-weight:600;padding:3px 9px;border-radius:20px;margin-top:8px\">Ideal Period: Less than 2 Months time for election date</div><div style=\"margin:10px 0 0;font-size:13px;color:#334155;line-height:1.55\">This model should be implemented only when there is limited time available to set up the SMCC and the first model cannot be implemented.<br><br>Under this model, the entire production team which includes CW, VE and GD is vendorised. SMAs are replaced with an on-ground SMCC OCC team comprising one reporter and one cameraman.<br><br><i>Note: Zonal Coordinators (ZCs) should not be vendorised, as they are responsible for taking key political and strategic decisions.</i></div></div></div><div style=\"font-size:12.5px;color:#475569;background:#f1f5f9;border-radius:8px;padding:10px 12px;margin-top:10px;line-height:1.55\"><b style=\"color:#0f172a\">Note:</b> There is no fixed rule that only one of these models must be adopted. A hybrid approach can also be implemented. For example, an SMCC-OCC team can be deployed in urban areas, while rural areas can operate with SMAs. News and narratives from urban regions are generally easier to capture and audiences often consume higher quality content production.</div><div style=\"font-size:11.5px;color:#64748b;margin-top:8px;font-style:italic;line-height:1.5\">Footnote (PDF): In Pondicherry, the SMCC was set up just two months before the election. This was the first instance where the entire production team was fully vendorised. After analysing the small geography of the UT, a strategic decision was made to deploy the SMCC-OCC model in the Pondicherry town region, while SMAs were deployed in the Karaikal region.</div>",
        "example": "<div style=\"margin-top:4px\"><div style=\"display:flex;align-items:center;gap:10px;margin-bottom:10px;flex-wrap:wrap\"><span style=\"background:#0f172a;color:#fff;font-size:10.5px;font-weight:700;letter-spacing:.6px;padding:4px 10px;border-radius:6px\">TAMIL NADU SMCC PRODUCTION TEAM</span><span style=\"font-size:13px;color:#0f172a;font-weight:700\">33 seats &nbsp;·&nbsp; Total: 55 members</span></div><table style=\"width:100%;border-collapse:collapse;font-size:13px;margin-top:6px\"><thead><tr style=\"background:#f1f5f9\"><th style=\"text-align:left;padding:8px 10px;border:1px solid #cbd5e1\">Team</th><th style=\"text-align:left;padding:8px 10px;border:1px solid #cbd5e1\">Role</th><th style=\"text-align:right;padding:8px 10px;border:1px solid #cbd5e1\">Nos.</th></tr></thead><tbody><tr><td style=\"padding:8px 10px;border:1px solid #cbd5e1;font-weight:700\">SMA</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">Social Media Associates</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">23</td></tr><tr><td rowspan=\"5\" style=\"padding:8px 10px;border:1px solid #cbd5e1;font-weight:700;vertical-align:top\">SMCC Production Team</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">Video Editors</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">10</td></tr><tr><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">Graphics Designers</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">5</td></tr><tr><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">Content Writers</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">9</td></tr><tr><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">Zonal Co-ordinators</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">3</td></tr><tr><td style=\"padding:8px 10px;border:1px solid #cbd5e1\">SM Executives &amp; Others</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">5</td></tr><tr style=\"background:#f1f5f9\"><td colspan=\"2\" style=\"padding:8px 10px;border:1px solid #cbd5e1;font-weight:700\">Total Team Members</td><td style=\"padding:8px 10px;border:1px solid #cbd5e1;text-align:right;font-weight:700\">55</td></tr></tbody></table></div>"
      },
      ...
      "coreFunctions": [
        {
          ...
          "items": [
            "<div style=\"display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;margin:8px 0 12px;text-align:center;list-style:none\"><div style=\"background:#dcfce7;border-radius:10px;padding:14px 10px\"><div style=\"font-size:11px;color:#15803d;font-weight:700;letter-spacing:.5px\">1</div><b>ESTABLISH BJP'S DIGITAL FOOTPRINT</b><div style=\"font-size:12.5px;margin-top:4px\">in every contested assembly segment</div></div><div style=\"background:#ffedd5;border-radius:10px;padding:14px 10px\"><div style=\"font-size:11px;color:#c2410c;font-weight:700;letter-spacing:.5px\">2</div><b>RUN HYPERLOCAL NARRATIVES</b><div style=\"font-size:12.5px;margin-top:4px\">that connect with voters at village, ward, and booth level</div></div><div style=\"background:#fee2e2;border-radius:10px;padding:14px 10px\"><div style=\"font-size:11px;color:#b91c1c;font-weight:700;letter-spacing:.5px\">3</div><b>ATTACK OPPOSITION MESSAGING</b><div style=\"font-size:12.5px;margin-top:4px\">through strategic counter-narrative content</div></div><div style=\"background:#f3e8ff;border-radius:10px;padding:14px 10px\"><div style=\"font-size:11px;color:#6b21a8;font-weight:700;letter-spacing:.5px\">4</div><b>AMPLIFY BJP'S GOVERNANCE ACHIEVEMENTS, CANDIDATE PROFILES &amp; PARTY IDEOLOGY</b></div><div style=\"background:#dbeafe;border-radius:10px;padding:14px 10px\"><div style=\"font-size:11px;color:#1d4ed8;font-weight:700;letter-spacing:.5px\">5</div><b>DRIVE VOTER ENGAGEMENT &amp; SENTIMENT SHIFT</b><div style=\"font-size:12.5px;margin-top:4px\">through targeted advertising</div></div></div><div style=\"display:flex;flex-wrap:wrap;gap:6px;justify-content:center;margin-bottom:6px\"><span style=\"background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af;padding:4px 10px;border-radius:20px;font-size:11.5px;font-weight:600\">Micro-Targeted Outreach</span><span style=\"background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af;padding:4px 10px;border-radius:20px;font-size:11.5px;font-weight:600\">Data-Driven Campaigns</span><span style=\"background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af;padding:4px 10px;border-radius:20px;font-size:11.5px;font-weight:600\">Voter Interaction &amp; Feedback</span><span style=\"background:#eff6ff;border:1px solid #bfdbfe;color:#1e40af;padding:4px 10px;border-radius:20px;font-size:11.5px;font-weight:600\">Sentiment Tracking &amp; Optimization</span></div>"
          ]
        },
        {
